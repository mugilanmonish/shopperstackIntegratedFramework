...
public class ListenerImplementationUi implements ITestListener {
	...
	public void onStart(ITestContext context) {
		ExtentSparkReporter htmlReport = new ExtentSparkReporter("./ExtentReportUi/ReportsUi.html");
		...
		reports.setSystemInfo("Base-Broswer", "firefox");
